...
const nextConfig = {
  ...
  generateStaticParams: async () => {
    return {
      excludePages: ['/404', '/_error', '/_not-found'],
    };
  },
}
...
// Run the build command with --no-static-generation flag
try {
  console.log('Running Next.js build with --no-static-generation flag');
  execSync('next build --no-lint --no-static-generation', { stdio: 'inherit' });
