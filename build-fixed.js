...
console.log('Creating simple not-found page');
if (fs.existsSync('src/app/not-found.tsx')) {
  fs.copyFileSync('src/app/not-found.tsx', 'src/app/not-found.tsx.backup');
}
...
try {
  ...
  if (fs.existsSync('src/app/not-found.tsx.backup')) {
    fs.copyFileSync('src/app/not-found.tsx.backup', 'src/app/not-found.tsx');
    fs.unlinkSync('src/app/not-found.tsx.backup');
  }
}
