...
import { getTransactionById } from "@/actions/transaction-actions-clean"
import { TransactionDetailCard } from "@/components/transactions/transaction-detail-card"
import { TransactionStatusUpdate } from "@/components/transactions/transaction-status-update"
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div>
          <TransactionStatusUpdate transaction={transaction} />
        </div>
      </div>
    </div>
  )
